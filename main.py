...
if __name__=='__main__': 
    print("TONS --> ", notes)
    Note = input("Digite o tom do seu Solo: ")
    Duration =  float(input("Digite a duração das notas *(Deve ser um número float e recomenda-se utilizar valores de 0.1 a 1): "))
    Note = Note.upper()
    if(input_check(Note)):
